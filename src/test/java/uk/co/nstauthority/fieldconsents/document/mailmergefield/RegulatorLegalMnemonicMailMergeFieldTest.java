...
class RegulatorLegalMnemonicMailMergeFieldTest {
  ...
  @Test
  void getDescription() {
    assertThat(regulatorLegalMnemonicMailMergeField.getDescription()).isEqualTo(RegulatorLegalMnemonicMailMergeField.DESCRIPTION);
  }
  ...
  void resolve() {
    ...
    assertThat(regulatorLegalMnemonicMailMergeField.resolve(documentInstanceDto))
        .isEqualTo(DocumentMailMergeFieldResolveResult.success(legalMnemonic));
  }
}

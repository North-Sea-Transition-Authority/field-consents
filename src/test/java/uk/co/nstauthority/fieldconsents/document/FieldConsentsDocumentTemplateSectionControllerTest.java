...
import uk.co.nstauthority.fieldconsents.document.lib.DocumentMailMergeFieldControllerHelperService;
import uk.co.nstauthority.fieldconsents.document.lib.DocumentMailMergeFieldView;
import uk.co.nstauthority.fieldconsents.document.lib.DocumentTemplateSectionConditionControllerHelperService;
import uk.co.nstauthority.fieldconsents.document.lib.DocumentTemplateSectionControllerHelperService;
import uk.co.nstauthority.fieldconsents.document.lib.DocumentTemplateSectionForm;
import uk.co.nstauthority.fieldconsents.document.lib.DocumentTemplateSectionFormValidator;
...
@ContextConfiguration(classes = FieldConsentsDocumentTemplateSectionController.class)
class FieldConsentsDocumentTemplateSectionControllerTest extends AbstractControllerTest {
  ...
  void getAddDocumentTemplateSectionBefore_noUser() throws Exception {
    mockMvc.perform(get(ReverseRouter.route(on(FieldConsentsDocumentTemplateSectionController.class)
  ...
  void getAddDocumentTemplateSectionBefore() throws Exception {
    ...
    mockMvc.perform(get(ReverseRouter.route(on(FieldConsentsDocumentTemplateSectionController.class)
        ...
        .andExpect(model().attribute("pageTitle", FieldConsentsDocumentTemplateSectionController.ADD_PAGE_TITLE))
        ...
        .andExpect(model().attribute("submitButtonText", FieldConsentsDocumentTemplateSectionController.ADD_SUBMIT_BUTTON_TEXT))
        .andExpect(model().attribute("cancelUrl", ReverseRouter.route(on(FieldConsentsDocumentTemplateController.class)
            .getViewDocumentTemplate(documentTemplateDto.id()))));
  }

  @SecurityTest
  void addDocumentTemplateSectionBefore_noUser() throws Exception {
    mockMvc.perform(post(ReverseRouter.route(on(FieldConsentsDocumentTemplateSectionController.class)
  ...
  void addDocumentTemplateSectionBefore_nullParent() throws Exception {
    ...
    mockMvc.perform(post(ReverseRouter.route(on(FieldConsentsDocumentTemplateSectionController.class)
        ...
        .andExpect(redirectedUrl(ReverseRouter.route(on(FieldConsentsDocumentTemplateController.class)
  ...
  void getEditDocumentTemplateSection() throws Exception {
    ...
    mockMvc.perform(get(ReverseRouter.route(on(FieldConsentsDocumentTemplateSectionController.class)
        ...
        .andExpect(model().attribute("pageTitle", FieldConsentsDocumentTemplateSectionController.EDIT_PAGE_TITLE))
        .andExpect(model().attribute("conditionsFdsSelectMap", conditionsFdsSelectMap))
        .andExpect(model().attribute("mailMergeFieldViews", applicableDocumentMailMergeFieldViews))
        .andExpect(model().attribute("submitButtonText", FieldConsentsDocumentTemplateSectionController.EDIT_SUBMIT_BUTTON_TEXT))
        .andExpect(model().attribute("cancelUrl", ReverseRouter.route(on(FieldConsentsDocumentTemplateController.class)
            .getViewDocumentTemplate(documentTemplateDto.id()))));
  }

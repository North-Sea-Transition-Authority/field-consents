...
class AdditionalInformationSummarySectionServiceTest {
  ...
  void getSummarySection_offshore(ApplicationType applicationType) {
    ...
    when(eiaDirectionService.getEiaDirectionSummaryDataView(applicationVersion))
        .thenReturn(summaryDataView);
    when(supportingInformationService.getSupportingInformationSummaryDataView(applicationVersion))
        .thenReturn(summaryDataView);
    ...
    assertSummaryItem(summaryItems.get(0), EIA_SCREENING_DIRECTION_ITEM, SIMPLE_SUMMARY, SummaryDataView.class);
    assertSummaryItem(summaryItems.get(1), SUPPORTING_INFORMATION_ITEM, SIMPLE_SUMMARY, SummaryDataView.class);
  }
  ...
  private void assertSectionAndSingleItem(Optional<SummarySection> summarySectionOptional) {
    ...
    assertSummaryItem(summaryItems.get(0), SUPPORTING_INFORMATION_ITEM, SIMPLE_SUMMARY, SummaryDataView.class);
  }

...
class ConsentTabConsentSummaryViewTest {
  ...
  void from(ApplicationType applicationType) {
    ...
    assertThat(
        ConsentTabConsentSummaryView.from(applicationType, consentLengthType, issuedByUser, issuedInstant,
            consentDataView, consentFigureUnitView, consentFieldEquityPartnersView, summaryFileViews))
        .isEqualTo(

...
public class SummaryTestUtil {
  ...
  public static void assertSummaryItem(SummaryItem<?> summaryItem,
    ...
    assertThat(summaryItem.summaryItemType()).isEqualTo(summaryItemType);
    assertThat(summaryItem.clazz()).isEqualTo(clazz);
    assertThat(summaryItem.summaryData()).isInstanceOf(clazz);
  }
}
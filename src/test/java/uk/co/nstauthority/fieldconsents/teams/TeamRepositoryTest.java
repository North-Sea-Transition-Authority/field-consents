...
import uk.co.nstauthority.fieldconsents.integrationtest.IntegrationTest;
...
class TeamRepositoryTest {
  ...
  void findAllTeamsThatUserIsMemberOf_whenUserInMultipleTeams() {
    ...
    teamRepository.saveAll(List.of(regulatorTeam, industryTeam));
    ...
    teamMemberRoleRepository.saveAll(List.of(regulatorTeamMemberRole, industryTeamMemberRole));

    var result = teamRepository.findAllTeamsThatUserIsMemberOf(user.wuaId());
    assertThat(result).containsExactlyInAnyOrder(regulatorTeam, industryTeam);
  }

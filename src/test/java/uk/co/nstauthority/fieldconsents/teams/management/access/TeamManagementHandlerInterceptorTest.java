...
class TeamManagementHandlerInterceptorTest {
  ...
  void preHandle_invokingUserHasStaticRole() throws Exception {
    ...
    when(teamQueryService.userHasStaticRole(invokingUser, TeamType.REGULATOR, Role.ACCESS_MANAGER))
        .thenReturn(true);
  ...
  void preHandle_InvokingUserCanManageTeam_scopedTeam() throws Exception {
    ...
    orgTeam.setTeamType(TeamType.INDUSTRY);
    ...
    when(teamManagementService.getScopedTeamsOfTypeUserCanManage(orgTeam.getTeamType(), invokingUser))
        .thenReturn(Set.of(orgTeam));
  ...
  void preHandle_invokingUserCanViewTeam_whenOrganisationTeam_andNotMemberOfTeam_andNotManageAnyOrganisationTeamRole_thenForbidden() throws Exception {
    ...
    when(teamManagementService.isMemberOfTeam(organisationTeam, invokingUser))
        .thenReturn(false);
  ...
  static class TestController {
    ...
    @InvokingUserHasStaticRole(teamType = TeamType.REGULATOR, role = Role.ACCESS_MANAGER)

...
public class TechnicalReviewAssignmentController {
  ...
  TechnicalReviewAssignmentController(
  ...
  public ModelAndView getTechnicalReviewAssignment(@PathVariable Integer applicationId) {
    ...
    return getTechnicalReviewAssignmentModelAndView(applicationVersion)
  ...
  private ModelAndView getTechnicalReviewAssignmentModelAndView(ApplicationVersion applicationVersion) {
    ...
    var technicalReviewerAssignmentCandidatesMap =
        technicalReviewAssignmentService.getTechnicalReviewerAssignmentCandidates(technicalReview)
            .stream()

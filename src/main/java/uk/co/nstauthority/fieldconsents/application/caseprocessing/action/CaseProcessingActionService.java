...
public class CaseProcessingActionService {
  ...
  private final Map<CaseProcessingActionItem, Set<RolePermission>> actionsToPermissions =
      Map.of(
          ...
          REGULATOR_ADD_CASE_NOTE, EnumSet.of(EDIT_FCS_CASE_PROCESSING_DOCUMENTS),
          TECHNICAL_REVIEWER_REASSIGN_OWNERSHIP, EnumSet.of(TECHNICAL_REVIEW_FCS_APPLICATIONS),
  ...
  private final Map<CaseProcessingActionItem, Set<CaseStatusFlag>> actionsToStatusFlags =
      Map.of(
          ...
          REGULATOR_ADD_CASE_NOTE, EnumSet.of(CASE_NOTES_ALLOWED),
          TECHNICAL_REVIEWER_REASSIGN_OWNERSHIP, EnumSet.of(TECHNICAL_REVIEW_OPEN),

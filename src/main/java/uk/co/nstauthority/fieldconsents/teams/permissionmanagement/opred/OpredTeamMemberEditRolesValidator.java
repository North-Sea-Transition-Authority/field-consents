...
@Service
class OpredTeamMemberEditRolesValidator implements SmartValidator {
  ...
  public static final String ROLES_NO_ACCESS_MANAGER_ERROR_CODE = "%s.accessManagerRequired".formatted(ROLES_FIELD_NAME);
  ...
  OpredTeamMemberEditRolesValidator(TeamMemberRemovalService teamMemberRemovalService) {
  ...
  public void validate(@Nullable Object target, @Nullable Errors errors, Object... validationHints) {
    // TODO - Merge with RegulatorTeamMemberEditRolesValidator
  ...
  private boolean canUpdateTeamMemberWithNewRoles(Team team, TeamMember teamMember,
                                                  Collection<OpredTeamRole> newRoles) {

    var accessManagerRole = OpredTeamRole.ACCESS_MANAGER;

...
@Controller
@RequestMapping("/permission-management/opred/{teamId}/remove/{wuaId}")
@HasTeamPermission(
    anyTeamPermissionOf = RolePermission.GRANT_ROLES,
    anyNonTeamPermissionOf = RolePermission.MANAGE_INDUSTRY_TEAMS
)
public class OpredRemoveMemberController extends AbstractTeamController {
  ...
  public OpredRemoveMemberController(
  ...
  public ModelAndView renderRemoveMember(@PathVariable("teamId") TeamId teamId,
    ...
    return new ModelAndView("fcs/permissionmanagement/removeTeamMemberPage")
        ...
        .addObject("backLinkUrl", ReverseRouter.route(on(
            OpredTeamManagementController.class)
            .renderMemberList(teamId)))
        .addObject("removeUrl", ReverseRouter.route(on(OpredRemoveMemberController.class)
  ...
  public ModelAndView removeMember(@PathVariable("teamId") TeamId teamId,
    ...
    if (!teamMemberRemovalService.canRemoveTeamMember(team, wuaId, OpredTeamRole.ACCESS_MANAGER)) {
    ...
    teamMemberRemovalService.removeTeamMember(team, teamMember, OpredTeamRole.ACCESS_MANAGER);

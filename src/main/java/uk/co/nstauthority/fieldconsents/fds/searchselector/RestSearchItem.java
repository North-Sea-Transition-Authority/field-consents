...
public record RestSearchItem(String id, String text) {
  ...
  public static RestSearchItem from(OrganisationGroup organisationGroup) {
    return new RestSearchItem(organisationGroup.getOrganisationGroupId().toString(), organisationGroup.getName());
  }

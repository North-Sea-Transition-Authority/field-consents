...
public class ApplicationDataFilterService {
  ...
  public Condition getApplicationNumberQueryCondition(String applicationNumber) {
    return APPLICATIONS.APPLICATION_NO.cast(String.class).eq(applicationNumber);
  }
  ...
  public List<Condition> getConditions(ApplicationDataFilterForm dataFilterForm) {
    ...
    Optional.ofNullable(dataFilterForm.getReferenceNumber())
        .map(this::getApplicationNumberQueryCondition)
        .ifPresent(conditions::add);

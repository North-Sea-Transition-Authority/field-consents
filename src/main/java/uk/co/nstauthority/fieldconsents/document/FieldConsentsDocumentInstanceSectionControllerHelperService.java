...
public class FieldConsentsDocumentInstanceSectionControllerHelperService {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(FieldConsentsDocumentInstanceSectionControllerHelperService.class);
  ...
  public DocumentInstanceSectionDto getDocumentInstanceSectionDtoForApplicationOrThrow(
    ...
    var documentInstanceApplicationId =
        documentInstanceLinkingService.getApplicationIdFromDocumentInstanceDtoOrThrowIfInvalidItemType(documentInstanceDto);

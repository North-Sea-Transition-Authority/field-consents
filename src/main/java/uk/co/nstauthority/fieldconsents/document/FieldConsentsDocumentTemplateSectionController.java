...
import uk.co.nstauthority.fieldconsents.document.lib.DocumentTemplateSectionController;
...
public class FieldConsentsDocumentTemplateSectionController implements DocumentTemplateSectionController {
  ...
  FieldConsentsDocumentTemplateSectionController(
  ...
  private ModelAndView getAddDocumentTemplateSectionModelAndView(
    ...
    return new ModelAndView("fcs/document/addOrEditDocumentTemplateSection")
        ...
        .addObject(
            "cancelUrl",
            ReverseRouter.route(on(FieldConsentsDocumentTemplateController.class)
  ...
  private ModelAndView addDocumentSection(
    ...
    return ReverseRouter.redirect(on(FieldConsentsDocumentTemplateController.class)
        .getViewDocumentTemplate(documentTemplateDto.id()));
  }

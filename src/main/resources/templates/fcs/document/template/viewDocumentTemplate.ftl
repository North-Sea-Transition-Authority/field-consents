...
<@defaultPageWithSubNavigation htmlTitle=pageTitle backLinkUrl=springUrl(backLinkUrl)>
    ...
    <@fdsSubNavigation.subNavigation>
      <@fdsSubNavigation.subNavigationSection>
        <#list topLevelDocumentTemplateSectionSummaryViews as documentTemplateSectionSummaryView>
          <@documentSectionSummaryViewSubnavigationItems documentTemplateSectionSummaryView/>
        </#list>
      </@fdsSubNavigation.subNavigationSection>
    </@fdsSubNavigation.subNavigation>
  ...
  <@defaultPageWithSubNavigationContent pageHeading=pageTitle>
    <#list topLevelDocumentTemplateSectionSummaryViews as documentTemplateSectionSummaryView>
      <@documentSectionSummaryViewContent documentTemplateSectionSummaryView/>
    </#list>
  </@defaultPageWithSubNavigationContent>
</@defaultPageWithSubNavigation>

<#macro documentSectionSummaryViewSubnavigationItems documentTemplateSectionSummaryView>
  ...
  <#list documentTemplateSectionSummaryView.children() as child>
    <@documentSectionSummaryViewSubnavigationItems documentTemplateSectionSummaryView=child/>
  </#list>
</#macro>

<#macro documentSectionSummaryViewContent documentTemplateSectionSummaryView>
  <div>
  ...
  <#list documentTemplateSectionSummaryView.children() as child>
    <@documentSectionSummaryViewContent documentTemplateSectionSummaryView=child/>
  </#list>
</#macro>

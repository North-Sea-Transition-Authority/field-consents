...
<#-- @ftlvariable name="teamMember" type="uk.co.nstauthority.fieldconsents.teams.TeamMemberView" -->
    ...
    <#if !canRemoveTeamMember>
      <@fdsWarning.warning>
          ...
          <@fdsDetails.details
              ...
              detailsText="If you wish to remove this user, you must give another team member the access manager role."
          />
      </@fdsWarning.warning>
    </#if>

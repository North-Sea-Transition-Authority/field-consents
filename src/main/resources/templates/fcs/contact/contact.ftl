  ...
  <div class="govuk-body">
    <div>
      ...
      <ul class="govuk-list govuk-list--bullet">
        <li>
          <a href="${accessibilityConfigurationProperties.productionGuidanceUrl()}" target="_blank">Production applications</a>
        </li>
        <li>
          <a href="${accessibilityConfigurationProperties.flareAndVentGuidanceUrl()}" target="_blank">Flare and vent applications</a>
        </li>
      </ul>
    </div>
    <div>

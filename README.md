...
|                                          |                                                                                                                                                                                                                                                                                                                                                                                                                            |   
| **EPMQ**                                 |                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `FCS_EPMQ_SNS_SQS_AWS_ACCESS_KEY_ID`     | AWS access key id for SNS/SQS <ul><li>[Local dev](https://tpm.fivium.co.uk/index.php/prj/view/147)</li></ul>                                                                                                                                                                                                                                                                                                               |
| `FCS_EPMQ_SNS_SQS_AWS_SECRET_ACCESS_KEY` | AWS secret access key for SNS/SQS <ul><li>[Local dev](https://tpm.fivium.co.uk/index.php/prj/view/147)</li></ul>                                                                                                                                                                                                                                                                                                           |
| `FCS_EPMQ_ENVIRONMENT_SUFFIX`            | Something unique per environment. For local dev this can be your initials, e.g. `hd`                                                                                                                                                                                                                                                                                                                                       |
...
| `FCS_ACTUATOR_ADMIN_USER_PASSWORD`          | Password for the actuator admin user                                                                                                                                                                                                                                                                                            |
|                                             |                                                                                                                                                                                                                                                                                                                                 |
| **Database**                                |                                                                                                                                                                                                                                                                                                                                 |
...
| `FCS_FMS_CONNECTION_TIMEOUT_SECONDS`        | Connection timeout in seconds. Defaults to `20`                                                                                                                                                                                                                                                                                 |
| `FCS_FMS_SUBMIT_ENDPOINT`                   | The FMS endpoint where feedback will be sent here. Defaults to `/api/v1/save-feedback`                                                                                                                                                                                                                                          |
| `FCS_FMS_PRESHARED_KEY`                     | This is the pre-shared key used when making requests                                                                                                                                                                                                                                                                            |
|                                             |                                                                                                                                                                                                                                                                                                                                 |    
| **EPMQ**                                    |                                                                                                                                                                                                                                                                                                                                 |
| `FCS_EPMQ_SNS_SQS_AWS_ACCESS_KEY_ID`        | AWS access key id for SNS/SQS <ul><li>[Dev](https://tpm.fivium.co.uk/index.php/prj/view/147)</li><li>[ST](https://tpm.fivium.co.uk/index.php/prj/view/147)</li><li>[Pre-prod](https://tpm.fivium.co.uk/index.php/pwd/view/2217)</li><li>[Prod](https://tpm.fivium.co.uk/index.php/pwd/view/2217)</li></ul>                      |
| `FCS_EPMQ_SNS_SQS_AWS_SECRET_ACCESS_KEY`    | AWS secret access key for SNS/SQS <ul><li>[Dev](https://tpm.fivium.co.uk/index.php/prj/view/147)</li><li>[ST](https://tpm.fivium.co.uk/index.php/prj/view/147)</li><li>[Pre-prod](https://tpm.fivium.co.uk/index.php/pwd/view/2217)</li><li>[Prod](https://tpm.fivium.co.uk/index.php/pwd/view/2217)</li></ul>                  |
| `FCS_EPMQ_ENVIRONMENT_SUFFIX`               | Something unique per environment, e.g. `dev`                                                                                                                                                                                                                                                                                    |
|                                             |                                                                                                                                                                                                                                                                                                                                 |    
| **Logout**                                  |                                                                                                                                                                                                                                                                                                                                 |  
| `FCS_ENERGY_PORTAL_LOGOUT_KEY`              | The pre-shared logout key for the energy portal  <ul><li>[Dev](https://tpm.fivium.co.uk/index.php/pwd/view/2098)</li><li>[ST](https://tpm.fivium.co.uk/index.php/pwd/view/2099)</li><li>[Pre-prod](https://tpm.fivium.co.uk/index.php/pwd/view/2096)</li><li>[Prod](https://tpm.fivium.co.uk/index.php/pwd/view/2097)</li></ul> |   
| `FCS_ENERGY_PORTAL_LOGOUT_URL`              | The URL to the log out entry theme of the Energy Portal<br/>                                                                                                                                                                                                                                                                    |   
|                                             |                                                                                                                                                                                                                                                                                                                                 |    
| **UK Energy Portal**                        |                                                                                                                                                                                                                                                                                                                                 |  
